...
class CustomAntEnv(MujocoEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.metadata = CustomAntEnv.metadata
        ...
        # position and velocity relative to its parent(whatever 'it' is)
        ...
        # we may include the external forces acting on the body
    ...
    def _get_obs(self):
        ...
        # the first two values are the x and y coordinates of the torso(root link)
