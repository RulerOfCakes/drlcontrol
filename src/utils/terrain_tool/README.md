***This tool is taken from the [unitree_mujoco](https://github.com/unitreerobotics/unitree_mujoco/blob/main/terrain_tool/readme.md) repository. Please refer to their [license](LICENSE) for usage details.***
