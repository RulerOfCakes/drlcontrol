...
INPUT_SCENE_PATH = ROBOT_DIR + "/scene_v2.xml"
...
class TerrainGenerator:
    ...
    def AddPerlinHeighField(
        ...
        cv2.imwrite(ROBOT_DIR + "/" + output_hfield_image,
                    terrain_image)
...
if __name__ == "__main__":
    ...
    # Perlin heigh field
    tg.AddPerlinHeighField(position=[0.0, 0.0, -0.5], size=[20.0, 20.0], height_scale=0.5,negative_height=0.2)
